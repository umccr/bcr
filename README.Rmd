...
You can install the development version of `bcr` from [GitHub](https://github.com/umccr/bcr) with:
...
There is a conda package version at <https://anaconda.org/pdiakumis/r-bcr>
