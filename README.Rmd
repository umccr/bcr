...
[![Travis build status](https://travis-ci.org/umccr/woofr.svg?branch=master)](https://travis-ci.org/umccr/woofr)
...
You can install the development version of `woofr` from [GitHub](https://github.com/umccr/woofr) with:
...
There is a conda package version at <https://anaconda.org/pdiakumis/r-woofr>
